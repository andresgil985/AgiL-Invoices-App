...
async function handleGoogleAuth() {
  ...
  if (!clientId) {
    alert('Por favor, ingresa un Google Client ID válido en el campo anterior primero.');
    return;
  }
...
function handleGoogleLogout() {
  ...
  localStorage.removeItem('google_token_expiry');
  updateGoogleSyncStatusUI();
  alert(document.getElementById('settingLanguage')?.value === 'en' ? 'Google account disconnected.' : 'Cuenta de Google desconectada.');
}
